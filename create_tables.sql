...
-- I decided to use familiar and conveniant imitation of the organization of the University.
-- There will be 5 tables (Departments, Professors, Courses, Enrollments and Students), some of which logically connected with each other.
